...
class SpeakerMessage(messages.Message):
    """SpeakerMessage-- outbound speaker string message"""
    speaker_msg = messages.StringField(1, required=True)
    sessions_msg = messages.StringField(2, required=True)
...
class ProfileForm(messages.Message):
    ...
    sessionKeysToAttend     = messages.StringField(6, repeated=True)
...
class Session(ndb.Model):
    """Session -- session is a child of Conference"""
    name            = ndb.StringProperty(required=True)
